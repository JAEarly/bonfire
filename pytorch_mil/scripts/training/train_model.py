from pytorch_mil.model import crc_models, mnist_models, musk_models, sival_models, tef_models
from pytorch_mil.train import CrcTrainer, MnistTrainer, MuskTrainer, SivalTrainer
...
def get_model_and_trainer_clz(dataset_name, model_name):
    ...
    if dataset_name == 'sival':
        model_clz = sival_models.get_model_clz_from_name(model_name)
