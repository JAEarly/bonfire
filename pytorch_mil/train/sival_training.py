...
from pytorch_mil.data.sival.sival_dataset import create_datasets, SIVAL_N_CLASSES
from pytorch_mil.model.sival_models import SivalGNN
...
class SivalTrainer(Trainer, ABC):
    ...
    def get_trainer_clz_from_model_clz(model_clz):
        return SivalGNNTrainer if model_clz == SivalGNN else SivalNetTrainer
