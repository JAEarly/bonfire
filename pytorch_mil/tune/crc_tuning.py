...
from pytorch_mil.model import crc_models
from pytorch_mil.train.crc_training import CrcNetTrainer, CrcGNNTrainer
...
def get_tuner_from_name(model_name):
    ...
    if model_name == 'GNN':
        return CrcGNNTuner
    raise ValueError("No CRC tuner implemented for model name {:s}".format(model_name))
